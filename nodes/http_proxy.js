//Schneider electric - Innovation 38HP4 - Grenoble
//Ismael IBN OMAR - Sandeep MISHRA
...
module.exports = function(RED) {
    ...
    function HTTPRequest(n) {
        ...
        //prox = n.proxy;
        //prox = "https://gateway.zscaler.net";
        //noprox = parseInt(this.port); 
    ...
    RED.nodes.registerType("SE_http_proxy",HTTPRequest,{
        credentials: {
            user: {type:"text"},
